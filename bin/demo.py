import curses, os; screen = curses.initscr()
import os
...
curses.init_pair(1,curses.COLOR_BLACK, curses.COLOR_RED) # Sets up color pair #1, it does black text with white background
...
menu_data = {
  ...
  'options':[
    { 'title': "CONTENT A", 'type': COMMAND, 'command': 'xbmc' },
        ...
        { 'title': "CREDITS", 'type': COMMAND, 'command': 'dosbox /media/samba/Apps/dosbox/doswin/WINDOWS/WIN.COM -conf /home/pi/scripts/dosbox2.conf -exit' },
